...
\midrule
Consensus & Validation Rules & \code{EloneBlockValidator} \\
...
The \code{EloneBlockValidator} enforces state monotonicity (Theorem~\ref{thm:isolation}) and reference existence:
...
struct EloneIndexer {
    // Fast O(1) lookups
    utxo_index: HashMap<OutPoint, EloneUTXO>,
...
pub struct PSTT {
    ...
    pub payload: Option<EloneTxPayload>,
