...
\textbf{Advantages}:
\begin{itemize}
    \item \textbf{Capital Efficiency}: $N$ pairs share $\sqrt{N}$ pools.
...
\toprule
\textbf{Metric} & \textbf{Traditional} & \textbf{Channel DEX} & \textbf{Improvement} \\
\midrule
Latency & 10--60~s & 15~ms & $1000\times$ \\
Cost/Trade & \$5--50 & \$0.001 & $10,\!000\times$ \\
MEV Risk & High & \textbf{None} & Eliminated \\
Throughput & 10 TPS & 20k TPS & $2000\times$ \\
\bottomrule
\end{tabularx}
\end{table}
